...
def generate_launch_description():
    ...
    # Declare launch arguments (equivalent to <arg> in ROS 1)
    ...
    # Set global parameter (equivalent to <param name="/use_sim_time" value="true"/>)
    ...
    # State estimator node (equivalent to <node> in ROS 1)
    state_estimator_node = Node(
        package='state_estimator',
        executable='state_estimator_node',  # Note: changed from 'node' to actual executable name
