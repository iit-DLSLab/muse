...
class VirtualModel {
public:
    typedef iit_commons::rbd::ForceVector Gains;
    typedef iit_commons::rbd::ForceVector Wrench;
    typedef iit_commons::rbd::InertiaMatrixDense InertiaMatrix;
    typedef iit_commons::planning::Point3d PointState;
