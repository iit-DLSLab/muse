...
"""autogenerated by genpy from state_estimator_msgs/SeActuatorReadings.msg. Do not edit."""
import codecs
import sys
...
class SeActuatorReadings(genpy.Message):
  _md5sum = "ff6230194b1da4ad6213f9aae966106d"
  _type = "state_estimator_msgs/SeActuatorReadings"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Series-elastic actuator readings
...
"""
  __slots__ = ['readings']
  _slot_types = ['state_estimator_msgs/SeActuatorReading[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SeActuatorReadings, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = state_estimator_msgs.msg.SeActuatorReading()
        _v15 = val1.header
        start = end
        end += 4
