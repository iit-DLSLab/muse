...
"""autogenerated by genpy from state_estimator_msgs/ExtendedJointState.msg. Do not edit."""
import codecs
import sys
...
class ExtendedJointState(genpy.Message):
  _md5sum = "393848425e33688e4c3305d16bf0a6f6"
  _type = "state_estimator_msgs/ExtendedJointState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# sensor_msgs/JointState with an additional field for acceleration.
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExtendedJointState, self).__init__(*args, **kwds)
