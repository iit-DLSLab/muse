...
"""autogenerated by genpy from series_elastic_actuator_msgs/SeActuatorReadingExtended.msg. Do not edit."""
import codecs
import sys
...
import series_elastic_actuator_msgs.msg
import std_msgs.msg

class SeActuatorReadingExtended(genpy.Message):
  _md5sum = "8ac9d8edf0f7d237de154004238775b6"
  _type = "series_elastic_actuator_msgs/SeActuatorReadingExtended"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Series-elastic actuator extended reading
#
Header header
# States
...
float32 pid_gains_d
"""
  __slots__ = ['header','state','commanded']
  _slot_types = ['std_msgs/Header','series_elastic_actuator_msgs/SeActuatorStateExtended','series_elastic_actuator_msgs/SeActuatorCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SeActuatorReadingExtended, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.state is None:
        self.state = series_elastic_actuator_msgs.msg.SeActuatorStateExtended()
      if self.commanded is None:
        self.commanded = series_elastic_actuator_msgs.msg.SeActuatorCommand()
    else:
      self.header = std_msgs.msg.Header()
      self.state = series_elastic_actuator_msgs.msg.SeActuatorStateExtended()
      self.commanded = series_elastic_actuator_msgs.msg.SeActuatorCommand()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_I7d3I().pack(_x.state.statusword, _x.state.current, _x.state.gear_position, _x.state.gear_velocity, _x.state.joint_position, _x.state.joint_velocity, _x.state.joint_acceleration, _x.state.joint_torque, _x.state.imu.header.seq, _x.state.imu.header.stamp.secs, _x.state.imu.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_get_struct_2d2i2dQ10d3I().pack(_x.state.motor_position, _x.state.motor_velocity, _x.state.gear_position_ticks, _x.state.joint_position_ticks, _x.state.temperature, _x.state.voltage, _x.state.timestamp, _x.state.desired_current_d, _x.state.measured_current_d, _x.state.desired_current_q, _x.state.measured_current_q, _x.state.measured_current_phase_u, _x.state.measured_voltage_phase_u, _x.state.measured_current_phase_v, _x.state.measured_voltage_phase_v, _x.state.measured_current_phase_w, _x.state.measured_voltage_phase_w, _x.commanded.header.seq, _x.commanded.header.stamp.secs, _x.commanded.header.stamp.nsecs))
      _x = self.commanded.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.commanded.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_h4d3f().pack(_x.commanded.mode, _x.commanded.current, _x.commanded.position, _x.commanded.velocity, _x.commanded.joint_torque, _x.commanded.pid_gains_p, _x.commanded.pid_gains_i, _x.commanded.pid_gains_d))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state.statusword, _x.state.current, _x.state.gear_position, _x.state.gear_velocity, _x.state.joint_position, _x.state.joint_velocity, _x.state.joint_acceleration, _x.state.joint_torque, _x.state.imu.header.seq, _x.state.imu.header.stamp.secs, _x.state.imu.header.stamp.nsecs,) = _get_struct_I7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.state.motor_position, _x.state.motor_velocity, _x.state.gear_position_ticks, _x.state.joint_position_ticks, _x.state.temperature, _x.state.voltage, _x.state.timestamp, _x.state.desired_current_d, _x.state.measured_current_d, _x.state.desired_current_q, _x.state.measured_current_q, _x.state.measured_current_phase_u, _x.state.measured_voltage_phase_u, _x.state.measured_current_phase_v, _x.state.measured_voltage_phase_v, _x.state.measured_current_phase_w, _x.state.measured_voltage_phase_w, _x.commanded.header.seq, _x.commanded.header.stamp.secs, _x.commanded.header.stamp.nsecs,) = _get_struct_2d2i2dQ10d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.commanded.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.commanded.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.commanded.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.commanded.name = str[start:end]
      _x = self
      start = end
      end += 46
      (_x.commanded.mode, _x.commanded.current, _x.commanded.position, _x.commanded.velocity, _x.commanded.joint_torque, _x.commanded.pid_gains_p, _x.commanded.pid_gains_i, _x.commanded.pid_gains_d,) = _get_struct_h4d3f().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2d2i2dQ10d3I = None
def _get_struct_2d2i2dQ10d3I():
    global _struct_2d2i2dQ10d3I
    if _struct_2d2i2dQ10d3I is None:
        _struct_2d2i2dQ10d3I = struct.Struct("<2d2i2dQ10d3I")
    return _struct_2d2i2dQ10d3I
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
...
_struct_h4d3f = None
def _get_struct_h4d3f():
    global _struct_h4d3f
    if _struct_h4d3f is None:
        _struct_h4d3f = struct.Struct("<h4d3f")
    return _struct_h4d3f
