...
class SeActuatorReading {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('state')) {
        ...
        this.state = new SeActuatorState();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SeActuatorState.serialize(obj.state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SeActuatorReading(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [state]
    data.state = SeActuatorState.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += SeActuatorState.getMessageSize(object.state);
  ...
  static datatype() {
    ...
    return 'series_elastic_actuator_msgs/SeActuatorReading';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '1fb7ba012b54edc7f93eb5f37eb6929d';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SeActuatorReading(null);
    ...
    if (msg.state !== undefined) {
      resolved.state = SeActuatorState.Resolve(msg.state)
    }
    else {
      resolved.state = new SeActuatorState()
    }
...
module.exports = SeActuatorReading;
