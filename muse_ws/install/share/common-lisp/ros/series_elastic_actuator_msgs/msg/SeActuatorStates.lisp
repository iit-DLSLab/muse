...
(cl:defclass <SeActuatorStates> (roslisp-msg-protocol:ros-message)
  ((states
    :reader states
    :initarg :states
    :type (cl:vector series_elastic_actuator_msgs-msg:SeActuatorState)
   :initform (cl:make-array 0 :element-type 'series_elastic_actuator_msgs-msg:SeActuatorState :initial-element (cl:make-instance 'series_elastic_actuator_msgs-msg:SeActuatorState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SeActuatorStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SeActuatorStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name series_elastic_actuator_msgs-msg:<SeActuatorStates> is deprecated: use series_elastic_actuator_msgs-msg:SeActuatorStates instead.")))

(cl:ensure-generic-function 'states-val :lambda-list '(m))
(cl:defmethod states-val ((m <SeActuatorStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader series_elastic_actuator_msgs-msg:states-val is deprecated.  Use series_elastic_actuator_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SeActuatorStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'series_elastic_actuator_msgs-msg:SeActuatorState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SeActuatorStates>)))
  ...
  "series_elastic_actuator_msgs/SeActuatorStates")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SeActuatorStates)))
  "Returns string type for a message object of type 'SeActuatorStates"
  "series_elastic_actuator_msgs/SeActuatorStates")
