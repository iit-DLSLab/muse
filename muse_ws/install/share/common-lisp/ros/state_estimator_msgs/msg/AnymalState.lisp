...
(cl:defclass <AnymalState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (joints
    :reader joints
    :initarg :joints
    :type state_estimator_msgs-msg:ExtendedJointState
    :initform (cl:make-instance 'state_estimator_msgs-msg:ExtendedJointState))
   (contacts
    :reader contacts
    :initarg :contacts
    :type (cl:vector state_estimator_msgs-msg:Contact)
   :initform (cl:make-array 0 :element-type 'state_estimator_msgs-msg:Contact :initial-element (cl:make-instance 'state_estimator_msgs-msg:Contact)))
   (frame_transforms
...
(cl:defmethod cl:initialize-instance :after ((m <AnymalState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnymalState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_estimator_msgs-msg:<AnymalState> is deprecated: use state_estimator_msgs-msg:AnymalState instead.")))
...
(cl:defmethod pose-val ((m <AnymalState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator_msgs-msg:pose-val is deprecated.  Use state_estimator_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <AnymalState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator_msgs-msg:twist-val is deprecated.  Use state_estimator_msgs-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'joints-val :lambda-list '(m))
(cl:defmethod joints-val ((m <AnymalState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator_msgs-msg:joints-val is deprecated.  Use state_estimator_msgs-msg:joints instead.")
  (joints m))

(cl:ensure-generic-function 'contacts-val :lambda-list '(m))
(cl:defmethod contacts-val ((m <AnymalState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator_msgs-msg:contacts-val is deprecated.  Use state_estimator_msgs-msg:contacts instead.")
  (contacts m))

(cl:ensure-generic-function 'frame_transforms-val :lambda-list '(m))
(cl:defmethod frame_transforms-val ((m <AnymalState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator_msgs-msg:frame_transforms-val is deprecated.  Use state_estimator_msgs-msg:frame_transforms instead.")
  (frame_transforms m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AnymalState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'contacts)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'state_estimator_msgs-msg:Contact))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AnymalState>)))
  ...
  "state_estimator_msgs/AnymalState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnymalState)))
  "Returns string type for a message object of type 'AnymalState"
  "state_estimator_msgs/AnymalState")
