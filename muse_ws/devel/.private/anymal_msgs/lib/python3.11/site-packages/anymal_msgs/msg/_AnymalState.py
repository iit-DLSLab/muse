...
"""autogenerated by genpy from anymal_msgs/AnymalState.msg. Do not edit."""
import codecs
import sys
...
class AnymalState(genpy.Message):
  _md5sum = "1bee66925f9d04663ad1cd7f4a496f93"
  _type = "anymal_msgs/AnymalState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Anymal state including generalized coordinates, velocities, and contacts.
...
"""
  ...
  __slots__ = ['header','state','pose','twist','joints','contacts','frame_transforms']
  _slot_types = ['std_msgs/Header','int8','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','anymal_msgs/ExtendedJointState','anymal_msgs/Contact[]','geometry_msgs/TransformStamped[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,state,pose,twist,joints,contacts,frame_transforms
    ...
    """
    if args or kwds:
      super(AnymalState, self).__init__(*args, **kwds)
      ...
      if self.joints is None:
        self.joints = anymal_msgs.msg.ExtendedJointState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_b3I().pack(_x.state, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6d3I().pack(_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.joints.header.seq, _x.joints.header.stamp.secs, _x.joints.header.stamp.nsecs))
      ...
      length = len(self.joints.acceleration)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.joints.acceleration))
      ...
      for val1 in self.contacts:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_2d().pack(_x.frictionCoefficient, _x.restitutionCoefficient))
      length = len(self.frame_transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.frame_transforms:
        _v8 = val1.header
        _x = _v8.seq
        buff.write(_get_struct_I().pack(_x))
        _v9 = _v8.stamp
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.joints.header.seq, _x.joints.header.stamp.secs, _x.joints.header.stamp.nsecs,) = _get_struct_6d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.joints.acceleration = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      for i in range(0, length):
        ...
        (_x.frictionCoefficient, _x.restitutionCoefficient,) = _get_struct_2d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.frame_transforms.append(val1)
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joints.acceleration.tostring())
      length = len(self.joints.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints.acceleration = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
