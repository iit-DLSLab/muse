...
(cl:defclass <SeActuatorReadingExtended> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (state
    :reader state
    :initarg :state
    :type series_elastic_actuator_msgs-msg:SeActuatorStateExtended
    :initform (cl:make-instance 'series_elastic_actuator_msgs-msg:SeActuatorStateExtended))
   (commanded
    :reader commanded
    :initarg :commanded
...
(cl:defmethod cl:initialize-instance :after ((m <SeActuatorReadingExtended>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SeActuatorReadingExtended)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name series_elastic_actuator_msgs-msg:<SeActuatorReadingExtended> is deprecated: use series_elastic_actuator_msgs-msg:SeActuatorReadingExtended instead.")))
