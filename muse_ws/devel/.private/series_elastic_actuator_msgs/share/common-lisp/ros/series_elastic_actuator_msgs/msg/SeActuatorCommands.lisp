...
(cl:defclass <SeActuatorCommands> (roslisp-msg-protocol:ros-message)
  ((commands
    :reader commands
    :initarg :commands
    :type (cl:vector series_elastic_actuator_msgs-msg:SeActuatorCommand)
   :initform (cl:make-array 0 :element-type 'series_elastic_actuator_msgs-msg:SeActuatorCommand :initial-element (cl:make-instance 'series_elastic_actuator_msgs-msg:SeActuatorCommand))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SeActuatorCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SeActuatorCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name series_elastic_actuator_msgs-msg:<SeActuatorCommands> is deprecated: use series_elastic_actuator_msgs-msg:SeActuatorCommands instead.")))

(cl:ensure-generic-function 'commands-val :lambda-list '(m))
(cl:defmethod commands-val ((m <SeActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader series_elastic_actuator_msgs-msg:commands-val is deprecated.  Use series_elastic_actuator_msgs-msg:commands instead.")
  (commands m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SeActuatorCommands>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'commands)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'series_elastic_actuator_msgs-msg:SeActuatorCommand))
