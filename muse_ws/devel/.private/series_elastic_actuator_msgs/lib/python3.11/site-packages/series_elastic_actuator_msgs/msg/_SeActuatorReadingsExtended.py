...
"""autogenerated by genpy from series_elastic_actuator_msgs/SeActuatorReadingsExtended.msg. Do not edit."""
import codecs
import sys
...
class SeActuatorReadingsExtended(genpy.Message):
  _md5sum = "9a8f2c5a9ba71ba57ebe8e54f9d205c9"
  _type = "series_elastic_actuator_msgs/SeActuatorReadingsExtended"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Series-elastic actuator readings extended
...
"""
  __slots__ = ['readings']
  _slot_types = ['series_elastic_actuator_msgs/SeActuatorReadingExtended[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SeActuatorReadingsExtended, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.readings:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = _v3
        buff.write(_get_struct_I7d().pack(_x.statusword, _x.current, _x.gear_position, _x.gear_velocity, _x.joint_position, _x.joint_velocity, _x.joint_acceleration, _x.joint_torque))
        _v6 = _v3.imu
        _v7 = _v6.header
        _x = _v7.seq
        buff.write(_get_struct_I().pack(_x))
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = _v12
        buff.write(_get_struct_h4d3f().pack(_x.mode, _x.current, _x.position, _x.velocity, _x.joint_torque, _x.pid_gains_p, _x.pid_gains_i, _x.pid_gains_d))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = series_elastic_actuator_msgs.msg.SeActuatorReadingExtended()
        _v15 = val1.header
        start = end
        end += 4
        ...
        (_x.statusword, _x.current, _x.gear_position, _x.gear_velocity, _x.joint_position, _x.joint_velocity, _x.joint_acceleration, _x.joint_torque,) = _get_struct_I7d().unpack(str[start:end])
        _v20 = _v17.imu
        _v21 = _v20.header
        start = end
        end += 4
        ...
        (_x.mode, _x.current, _x.position, _x.velocity, _x.joint_torque, _x.pid_gains_p, _x.pid_gains_i, _x.pid_gains_d,) = _get_struct_h4d3f().unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.readings:
        ...
        _x = _v37
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_v34.orientation_covariance.tostring())
        _v38 = _v34.angular_velocity
        _x = _v38
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_v34.angular_velocity_covariance.tostring())
        _v39 = _v34.linear_acceleration
        _x = _v39
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_v34.linear_acceleration_covariance.tostring())
        _x = _v31
        buff.write(_get_struct_2d2i2dQ10d().pack(_x.motor_position, _x.motor_velocity, _x.gear_position_ticks, _x.joint_position_ticks, _x.temperature, _x.voltage, _x.timestamp, _x.desired_current_d, _x.measured_current_d, _x.desired_current_q, _x.measured_current_q, _x.measured_current_phase_u, _x.measured_voltage_phase_u, _x.measured_current_phase_v, _x.measured_voltage_phase_v, _x.measured_current_phase_w, _x.measured_voltage_phase_w))
        _v40 = val1.commanded
        _v41 = _v40.header
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v45.name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        _v48.orientation_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
        _v52 = _v48.angular_velocity
        _x = _v52
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        ...
        _v48.angular_velocity_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
        _v53 = _v48.linear_acceleration
        _x = _v53
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        ...
        _v48.linear_acceleration_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
        _x = _v45
        start = end
        end += 128
        (_x.motor_position, _x.motor_velocity, _x.gear_position_ticks, _x.joint_position_ticks, _x.temperature, _x.voltage, _x.timestamp, _x.desired_current_d, _x.measured_current_d, _x.desired_current_q, _x.measured_current_q, _x.measured_current_phase_u, _x.measured_voltage_phase_u, _x.measured_current_phase_v, _x.measured_voltage_phase_v, _x.measured_current_phase_w, _x.measured_voltage_phase_w,) = _get_struct_2d2i2dQ10d().unpack(str[start:end])
        ...
        if python3:
          _v54.name = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v54.name = str[start:end]
        _x = _v54
        start = end
        end += 46
        (_x.mode, _x.current, _x.position, _x.velocity, _x.joint_torque, _x.pid_gains_p, _x.pid_gains_i, _x.pid_gains_d,) = _get_struct_h4d3f().unpack(str[start:end])
