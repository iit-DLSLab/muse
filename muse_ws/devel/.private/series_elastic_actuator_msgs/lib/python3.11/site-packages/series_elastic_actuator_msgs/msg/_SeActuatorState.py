...
"""autogenerated by genpy from series_elastic_actuator_msgs/SeActuatorState.msg. Do not edit."""
import codecs
import sys
...
class SeActuatorState(genpy.Message):
  _md5sum = "5beb885e629c734ee244b26cb1ffcc17"
  _type = "series_elastic_actuator_msgs/SeActuatorState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Series-elastic actuator state
...
float64 y
float64 z"""
  __slots__ = ['header','name','statusword','current','gear_position','gear_velocity','joint_position','joint_velocity','joint_acceleration','joint_torque','imu']
  _slot_types = ['std_msgs/Header','string','uint32','float64','float64','float64','float64','float64','float64','float64','sensor_msgs/Imu']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,statusword,current,gear_position,gear_velocity,joint_position,joint_velocity,joint_acceleration,joint_torque,imu
    ...
    """
    if args or kwds:
      super(SeActuatorState, self).__init__(*args, **kwds)
