...
"""autogenerated by genpy from series_elastic_actuator_msgs/SeActuatorCommand.msg. Do not edit."""
import codecs
import sys
...
class SeActuatorCommand(genpy.Message):
  _md5sum = "99caa130fb942b20d4b16f18464e90d2"
  _type = "series_elastic_actuator_msgs/SeActuatorCommand"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Series-elastic actuator command
...
"""
  ...
  __slots__ = ['header','name','mode','current','position','velocity','joint_torque','pid_gains_p','pid_gains_i','pid_gains_d']
  _slot_types = ['std_msgs/Header','string','int16','float64','float64','float64','float64','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,mode,current,position,velocity,joint_torque,pid_gains_p,pid_gains_i,pid_gains_d
    ...
    """
    if args or kwds:
      super(SeActuatorCommand, self).__init__(*args, **kwds)
      ...
      if self.joint_torque is None:
        self.joint_torque = 0.
      if self.pid_gains_p is None:
        self.pid_gains_p = 0.
      if self.pid_gains_i is None:
        self.pid_gains_i = 0.
      if self.pid_gains_d is None:
        self.pid_gains_d = 0.
    else:
      self.header = std_msgs.msg.Header()
      self.name = ''
