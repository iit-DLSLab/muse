...
(cl:defclass <SeActuatorReading> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (state
    :reader state
    :initarg :state
    :type state_estimator_msgs-msg:SeActuatorState
    :initform (cl:make-instance 'state_estimator_msgs-msg:SeActuatorState))
   (commanded
    :reader commanded
    :initarg :commanded
...
(cl:defmethod cl:initialize-instance :after ((m <SeActuatorReading>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SeActuatorReading)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_estimator_msgs-msg:<SeActuatorReading> is deprecated: use state_estimator_msgs-msg:SeActuatorReading instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SeActuatorReading>)))
  ...
  "state_estimator_msgs/SeActuatorReading")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SeActuatorReading)))
  "Returns string type for a message object of type 'SeActuatorReading"
  "state_estimator_msgs/SeActuatorReading")
