...
class ExtendedJointState {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ExtendedJointState
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ExtendedJointState
    let len;
    let data = new ExtendedJointState(null);
  ...
  static datatype() {
    ...
    return 'state_estimator_msgs/ExtendedJointState';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExtendedJointState(null);
...
module.exports = ExtendedJointState;
