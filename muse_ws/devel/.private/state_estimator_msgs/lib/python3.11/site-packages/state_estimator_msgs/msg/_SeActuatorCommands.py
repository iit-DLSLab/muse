...
"""autogenerated by genpy from state_estimator_msgs/SeActuatorCommands.msg. Do not edit."""
import codecs
import sys
...
class SeActuatorCommands(genpy.Message):
  _md5sum = "8bac105afcdb07f69773e72515936600"
  _type = "state_estimator_msgs/SeActuatorCommands"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Series-elastic actuator commands
...
"""
  __slots__ = ['commands']
  _slot_types = ['state_estimator_msgs/SeActuatorCommand[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SeActuatorCommands, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = state_estimator_msgs.msg.SeActuatorCommand()
        _v3 = val1.header
        start = end
        end += 4
