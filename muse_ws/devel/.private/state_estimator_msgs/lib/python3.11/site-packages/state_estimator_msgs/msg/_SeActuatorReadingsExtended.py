...
"""autogenerated by genpy from state_estimator_msgs/SeActuatorReadingsExtended.msg. Do not edit."""
import codecs
import sys
...
class SeActuatorReadingsExtended(genpy.Message):
  ...
  _type = "state_estimator_msgs/SeActuatorReadingsExtended"
...
"""
  __slots__ = ['readings']
  _slot_types = ['state_estimator_msgs/SeActuatorReadingExtended[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = state_estimator_msgs.msg.SeActuatorReadingExtended()
        _v15 = val1.header
        start = end
        end += 4
