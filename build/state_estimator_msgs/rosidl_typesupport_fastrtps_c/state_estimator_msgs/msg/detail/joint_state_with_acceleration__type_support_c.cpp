...
#include "state_estimator_msgs/msg/detail/joint_state_with_acceleration__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // acceleration, effort, position, velocity
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // acceleration, effort, position, velocity
...
using _JointStateWithAcceleration__ros_msg_type = state_estimator_msgs__msg__JointStateWithAcceleration;
...
size_t get_serialized_size_state_estimator_msgs__msg__JointStateWithAcceleration(
  ...
  size_t current_alignment)
{
  const _JointStateWithAcceleration__ros_msg_type * ros_message = static_cast<const _JointStateWithAcceleration__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = state_estimator_msgs__msg__JointStateWithAcceleration;
    is_plain =
      (
...
static bool _JointStateWithAcceleration__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const state_estimator_msgs__msg__JointStateWithAcceleration * ros_message = static_cast<const state_estimator_msgs__msg__JointStateWithAcceleration *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_state_estimator_msgs__msg__JointStateWithAcceleration(ros_message, cdr);
}

static bool _JointStateWithAcceleration__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  state_estimator_msgs__msg__JointStateWithAcceleration * ros_message = static_cast<state_estimator_msgs__msg__JointStateWithAcceleration *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_state_estimator_msgs__msg__JointStateWithAcceleration(cdr, ros_message);
}

static uint32_t _JointStateWithAcceleration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_state_estimator_msgs__msg__JointStateWithAcceleration(
      untyped_ros_message, 0));
}

static size_t _JointStateWithAcceleration__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_state_estimator_msgs__msg__JointStateWithAcceleration(
...
static message_type_support_callbacks_t __callbacks_JointStateWithAcceleration = {
  "state_estimator_msgs::msg",
  "JointStateWithAcceleration",
  _JointStateWithAcceleration__cdr_serialize,
  _JointStateWithAcceleration__cdr_deserialize,
  _JointStateWithAcceleration__get_serialized_size,
  _JointStateWithAcceleration__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _JointStateWithAcceleration__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointStateWithAcceleration,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, msg, JointStateWithAcceleration)() {
  return &_JointStateWithAcceleration__type_support;
}
