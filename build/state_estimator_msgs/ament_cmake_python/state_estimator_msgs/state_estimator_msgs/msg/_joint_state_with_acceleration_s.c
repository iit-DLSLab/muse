...
bool state_estimator_msgs__msg__joint_state_with_acceleration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("state_estimator_msgs.msg._joint_state_with_acceleration", (char *)PyUnicode_1BYTE_DATA(module_attr), 55) == 0);
    assert(strncmp("JointStateWithAcceleration", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  state_estimator_msgs__msg__JointStateWithAcceleration * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of JointStateWithAcceleration */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("state_estimator_msgs.msg._joint_state_with_acceleration");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointStateWithAcceleration");
