...
#include "state_estimator_msgs/msg/detail/attitude__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = state_estimator_msgs::msg::Attitude;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const state_estimator_msgs::msg::Attitude *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<state_estimator_msgs::msg::Attitude *>(
    untyped_ros_message);
...
{
  return &state_estimator_msgs::msg::typesupport_fastrtps_cpp::_Attitude__handle;
}
