...
static const _JointStateWithAcceleration_type_support_symbol_names_t _JointStateWithAcceleration_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, state_estimator_msgs, msg, JointStateWithAcceleration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, state_estimator_msgs, msg, JointStateWithAcceleration)),
  }
};
...
{
  return &::state_estimator_msgs::msg::rosidl_typesupport_cpp::JointStateWithAcceleration_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, state_estimator_msgs, msg, JointStateWithAcceleration)() {
  return get_message_type_support_handle<state_estimator_msgs::msg::JointStateWithAcceleration>();
}
