...
static const _LegOdometry_type_support_symbol_names_t _LegOdometry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, state_estimator_msgs, msg, LegOdometry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, state_estimator_msgs, msg, LegOdometry)),
  }
};
...
{
  return &::state_estimator_msgs::msg::rosidl_typesupport_cpp::LegOdometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, state_estimator_msgs, msg, LegOdometry)() {
  return get_message_type_support_handle<state_estimator_msgs::msg::LegOdometry>();
}
