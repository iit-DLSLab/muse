...
#ifndef STATE_ESTIMATOR_MSGS__MSG__DETAIL__CONTACT_DETECTION__TYPE_SUPPORT_H_
#define STATE_ESTIMATOR_MSGS__MSG__DETAIL__CONTACT_DETECTION__TYPE_SUPPORT_H_
...
#endif  // STATE_ESTIMATOR_MSGS__MSG__DETAIL__CONTACT_DETECTION__TYPE_SUPPORT_H_
